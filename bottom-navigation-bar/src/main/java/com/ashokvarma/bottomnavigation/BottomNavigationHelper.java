...
class BottomNavigationHelper {
    ...
    private static void setBadgeForTab(BadgeItem badgeItem, BottomNavigationTab bottomNavigationTab) {
        if (badgeItem != null) {
            ...
            //设置字体
            if(Utils.getCurrentSystemLanguage(context) == 1) {
                bottomNavigationTab.badgeView.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/bottom_ch.ttf"));
            }else {
                bottomNavigationTab.badgeView.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/bottom_en.ttf"));
            }
